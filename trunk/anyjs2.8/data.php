...
$json=array(array('a'=>'enimo1','b'=>'test1'),array('a'=>'enimo2','b'=>'test2'));
echo json_encode($json);
}
else if($type=="jsonp"){
header("Content-Type:application/x-javascript; charset=utf-8");
$callback = isset($_GET['callback']) ? $_GET['callback'] : 'JSONP';
$json=array(array('a'=>'enimo1jsonp','b'=>'test1jsonp'),array('a'=>'enimo2','b'=>'test2jsonp'));
echo 'var '.$callback.'='.json_encode($json);
}
else{echo '<i>ABC</i>';}